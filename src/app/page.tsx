    ...
    <main className="overflow-hidden bg-white">
      ...
      <header className="relative z-20 bg-white">
        <div className="container flex h-24 items-center justify-between gap-6 lg:h-28">
          <a className="flex min-w-0 items-center" href="#">
            <Image src="/assets/tcog-logo-transparent-navy.png" alt="The Church of God logo" width={1986} height={216} className="h-auto w-[clamp(220px,28vw,380px)] object-contain" priority />
          </a>
        ...
        <div className="container grid gap-16 lg:grid-cols-2">
          ...
          <div id="contact" className="relative">
            ...
            <div className="pointer-events-none absolute right-0 top-8 hidden opacity-10 md:block">
              <Image src="/assets/tcog-logo-transparent-navy.png" alt="" width={310} height={130} />
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="relative bg-navy pt-12 text-white">
        ...
        <div className="container grid gap-10 pb-10 md:grid-cols-[1.5fr_0.8fr_0.8fr_1fr]">
          <div>
            <Image src="/assets/tcog-logo-transparent-white.png" alt="The Church of God footer logo" width={1986} height={216} className="h-auto w-[min(320px,100%)] object-contain object-left" />
